...
According to the screenshot of the person form shown in \figref{my_contacts_swt} the form is organized into an upper box including the frist name, the last name and a picture field. 
...
As this form only holds a single URL field, we omit the description of the creation of the URL edior form's content and provide the resulting Java code instead. 
...
For the \java{load} method in \lstref{mycontacts.server.services.personservice.load} it is assumed that the in the provided parameter \java{formData} the person's id is available as a seach criteria. 
...
In prinicple, method \java{prepareCreate} is not needed for the ''My Contacts'' application. 
