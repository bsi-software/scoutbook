package org.eclipse.scout.transport.server;
 ...
 * org.eclipse.equinox.http.jetty.context.path=/transport_server
 ...
 * eclipse.product=org.eclipse.scout.transport.server.product
 */
public class ServerApplication implements IApplication {
  ...
  public Object start(IApplicationContext context) throws Exception {
    ...
    */
    logger.info("transport server initialized");
    return EXIT_OK;
  }
