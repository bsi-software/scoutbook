...
Start the Scout server using the product launcher icons provided in the server box of the Scout Object Properties associated with the root node of the application.
Either click on the icon with the white triangle in the green circle of the right hand side of the box, or, click on the green bug icon right below to start the server in debug mode.
...
Expanding the \element{DesktopForm}, its children \element{Variables}, \element{MainBox}, and \element{Handlers} are revealed.
