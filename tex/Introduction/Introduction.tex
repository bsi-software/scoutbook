...
\begin{figure}
\includediagram{12cm}{scout_app_architecture_desktop}
...
The architecture of a Scout client server created by the Scout SDK is shown in In \figref{scout_app_architecture_desktop}.
...
This is illustrated in \figref{scout_app_architecture_desktop} and \figref{scout_app_architecture_web} where the Scout UI rendering compontents for Swing, SWT and RAP are shown to be part of the Scout framwork itself. 
...
\begin{itemize}
  ...
  \item \secref{my_contacts_guide} ``The My Contacts Application''. 
...
If you did not already go through \secref{what_is_scout} please do so now. 
