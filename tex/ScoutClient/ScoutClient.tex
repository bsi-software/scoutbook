...
The setup of this service tunnel is typical initiated in method \java{execLoadSession} of the client's \java{ClientSession} class. 
Therefore, the setup of the service tunnel is commented out in the Scout widget demo as shown in \lstref{demoapp.clientsession}. 
...
As the widget demo does not have a server but we still want to work with codes and code types, a \java{LocalCodeService} class had to be added to the client's plugin. 
