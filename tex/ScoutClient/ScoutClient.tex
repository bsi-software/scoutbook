...
TODO: add something on table organisation:
\begin{itemize}
  \item Column order (drag and drop)
  \item Sorting order (including multiple sort order)
  \item Filter
  \item This can be done with the dialog to organize tables.
\end{itemize}
