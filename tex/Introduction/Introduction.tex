...
For Scout web and mobile clients, the Eclipse RAP framework\footnote{
...
In this background section we take a closer look at Scout's service infrastructure and the client server communication.
To discuss the setup and usage of the \java{DesktopService} in the ''Hello World'' example.
