...
Select the \textit{Windows x64} package if you are running 64-bit Windows as shown in \figref{jdk_download_oracle}.
...
\begin{figure}
\includegraphics[height=20cm]{scout_download.png}
