...
\begin{figure}
\includegraphics[width=4cm]{wizard_page_1.png} \hspace{5mm}
\includegraphics[width=4cm]{wizard_page_2.png} \hspace{5mm}
\includegraphics[width=4cm]{wizard_page_3.png}
...
For a detailed introduction into code types and codes see \secref{code_types_codes}. 
...
\begin{figure}
\includegraphics[width=14cm]{sdk_nls_editor2.png}
...
As shown in \figref{nls_editor}, the NLS editor can be opened using the \link{Open NLS Editor ...} in the Scout Object Properties view.
