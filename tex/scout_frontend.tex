...
\ifpdf
  \includepdf[pages=-]{ScoutBookCoverFrontend.pdf}
\else
  \includegraphics{ScoutBookCoverFrontend.png}
\fi
...
% --------------------------------------------------------------------------- %
\include{Introduction/IntroductionFrontend}
