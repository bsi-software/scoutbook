 ...
 * @author mzi
 */
public class FontLookupCall extends LocalLookupCall<String> {
  ...
  protected List<? extends ILookupRow<String>> execCreateLookupRows() throws ProcessingException {
    ...
    for (String key : SERVICES.getService(IFontIconProviderService.class).getFontKeys()) {
      rows.add(new LookupRow<String>(key, key));
    }
