...
\caption{Above, the definition of the products \filename{config.ini} in tab \element{Configuration} of the product file editor.
...
% ........................................................................... %
\subsection{Scout Web and Mobile Clients}

For Scout web and mobile clients, the RAP framework\footnote{
...
\caption{The NLS editor provided by the Scout SDK. This editor is opened via the \menu{Open NLS Editor} in the Scout Object Properties of the \node{DefaultTextProviderService}.
}
\figlabel{nls_editor}
\end{figure}
...
On the right side, the location of property file \filename{Texts_de_CH.properties} in the shared plugin of the ''Hello World'' application is shown.
}
\figlabel{adding_a_language}
\end{figure}

When we did add the \field{Message} to the desktop form of the ''Hello World'' application we had to add a new translation entry for the label of the message field as shown in \figref{helloworld_stringfield}.
To access the translated label field entry, the Scout SDK generated the implementation of \java{getConfiguredLabel} using \java{TEXTS.get("Message")} as shown in \lstref{helloworld.mainbox}.
As translated texts may need to be available for both the Scout client and the Scout server application the complete infrastructure needed for the NLS support is located in the application's shared plugin.
...
In this background section we take a closer look at the connection between form handling and calling server services.


Even though this particular method looks simple and innocent, these form service methods are where the bulk of your server side code will end up.
