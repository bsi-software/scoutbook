...
If the radio buttons have assigned individual values of the Java type \class{Long} the currently selected value may be obtained using the \java{getValue} method of the radio button group. 
