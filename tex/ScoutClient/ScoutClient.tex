...
As the name ''shared创 already indicates, this plugin contains code and resources that need to be available to both the Scout client and the server application. 
...
This is exactly the scenario that was used in the ''My Contacts创 application of the book's first part in \secref{adding_the_smartfield}. 
...
\lstref{field.radiobuttongroup} provides the implementation of ''Default创 radio button group \java{DefaultGroup}. 
...
This approach has been used for the ''Styled创 radio button group in the example section of the \java{RadioButtonGroupFieldForm}. 
...
As smart fields offer ''search-as-you-type创 functionality, the field works well for very large sets of elements.  
...
By typing a part of the name of the desired entry into the field, the ''search-as-you-type创 support kicks in and a filtered list of elements is displayed. 
...
Smart fields support ''search-as-you-type创 and are used to select a value from of a list of elements or a tree.}
\figlabel{smartfield}
\end{figure}
