...
This works well when the data to be looked up is based on a code type for example. 
...
For large amounts of external data, the lookup call will make use of a lookup service that is providing the necessary data. 
