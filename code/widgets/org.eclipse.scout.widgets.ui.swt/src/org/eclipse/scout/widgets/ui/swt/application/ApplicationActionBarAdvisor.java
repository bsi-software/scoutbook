package org.eclipse.scout.widgets.ui.swt.application;
...
import org.eclipse.scout.widgets.ui.swt.SwtEnvironment;
import org.eclipse.scout.widgets.ui.swt.application.button.CoolbarButton;
...
public class ApplicationActionBarAdvisor extends ActionBarAdvisor {
  ...
  public void initViewButtons(IDesktop d) {
    ...
    if (viewButtons.length + toolButtons.length > NUM_OUTLINE_BUTTONS) {
      logger.warn("There are more buttons configured in the desktop model (" + viewButtons.length + " + " + toolButtons.length + ") than prepared in the SWT UI. Consider to increase 'NUM_OUTLINE_BUTTONS' in class '" + getClass().getName() + "'.");
    }
  }
