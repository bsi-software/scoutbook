...
Expand the \node{shared} node of the Eclipse Scout project in the Explorer View and select the \folder{Icons} folder. Click the link \textsc{Open Icons Editor} in the Object Properties View. 
