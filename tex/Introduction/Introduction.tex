...
In the first wizard step, shown on the right hand side of \figref{sdk_export_war} the target directory for the WAR files needs to be specified.
...
\begin{figure}
\includegraphics[width=7cm]{sdk_export_war_menu.png} \hspace{5mm}
\includegraphics[width=7cm]{export_wizard_1.png}
\caption{Starting the \wizard{Export Scout Project} in the Scout SDK over the context menu. 
...
\begin{figure}
\includegraphics[width=8cm]{export_wizard_3.png} \hspace{5mm}
\includegraphics[width=6cm]{export_wizard_4.png}
\caption{To include the Swing client in the \texttt{helloworld\_server.war} file select the corresponding client product (left). 
In the last step of the export wizard the RAP sever is exported to the specified file name (right).}
\figlabel{export_wizard}
\end{figure}
