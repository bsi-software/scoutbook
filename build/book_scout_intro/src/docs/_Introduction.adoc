...
---- 
include::{codedir}/helloworld/org.eclipse.scout.helloworld.client/src/org/eclipse/scout/helloworld/client/ui/forms/DesktopForm.java[lines=19..20]
include::{codedir}/helloworld/org.eclipse.scout.helloworld.client/src/org/eclipse/scout/helloworld/client/ui/forms/DesktopForm.java[lines=86..103]
----
...
---- 
include::{codedir}/helloworld/org.eclipse.scout.helloworld.client/src/org/eclipse/scout/helloworld/client/ui/forms/DesktopForm.java[lines=18..20]
include::{codedir}/helloworld/org.eclipse.scout.helloworld.client/src/org/eclipse/scout/helloworld/client/ui/forms/DesktopForm.java[lines=69..84]
include::{codedir}/helloworld/org.eclipse.scout.helloworld.client/src/org/eclipse/scout/helloworld/client/ui/forms/DesktopForm.java[lines=102..103]
----
...
---- 
include::{codedir}/helloworld/org.eclipse.scout.helloworld.server/plugin.xml[lines=1..6]
include::{codedir}/helloworld/org.eclipse.scout.helloworld.server/plugin.xml[lines=22..27]
include::{codedir}/helloworld/org.eclipse.scout.helloworld.server/plugin.xml[lines=105..106]
----
...
.The configuration of the server's resource servlet in the [java]+plugin.xml+ configuration file. The remaining content of the file has been omitted.
---- 
include::{codedir}/helloworld/org.eclipse.scout.helloworld.server/plugin.xml[lines=1..3]
include::{codedir}/helloworld/org.eclipse.scout.helloworld.server/plugin.xml[lines=28..30]
include::{codedir}/helloworld/org.eclipse.scout.helloworld.server/plugin.xml[lines=51..62]
include::{codedir}/helloworld/org.eclipse.scout.helloworld.server/plugin.xml[lines=104..106]
----
