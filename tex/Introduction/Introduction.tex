...
Rayo has been designed in 2009 by BSI for the desktop clients of its CRM\footnote{
Customer Relationship Management (CRM): \url{https://en.wikipedia.org/wiki/Customer_relationship_management}} 
application and its contact center solution.
...
At the core of the Rayo lies Java Synth look and feel\footnote{
Java Synth Look and Feel: \url{http://en.wikipedia.org/wiki/Synth_Look_and_Feel}
}.

In 2011, the Scout framework supports web applications, rayo for rap, no need to go to marketplace.
