...
% --------------------------------------------------------------------------- %
\section{Client Component Model}
needs text
...
\noindent Existing Documentation
\begin{itemize}
  \item forum: no so rocky support \url{http://www.eclipse.org/forums/index.php/t/305966/}
\end{itemize}
...
% --------------------------------------------------------------------------- %
\section{Rayo Look and Feel (Swing and Web)}
needs text
...
\subsection{Branding the Swing Client}
needs text
...
\subsection{Client Shutdown}
needs text

\subsection{Caching}
needs text
  
\subsection{File Up-/Download}
needs text, same topic addressed in scout server. decide where to put this topic

\noindent Existing Documentation
\begin{itemize}
  \item remotefileservice forum \url{http://www.eclipse.org/forums/index.php/t/266862/}
  \item file download forum \url{http://www.eclipse.org/forums/index.php/t/263896/}
\end{itemize}
