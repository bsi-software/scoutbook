...
Finally, the link is added with the \wizard{New Form Field} too. 
In the first wizard step select the type \java{LinkButton} and use a new text ''Show Map ...'' for the \field{Name}
